...
# Train each model 10 times with the 10 random seeds in parallel with cpu (check core number) delivers results much faster than training iteratively with gpu
...
do
   ...
   ###### Optimized (slightly underperforming with respect to results from original work)
